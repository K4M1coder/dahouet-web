 ...
 * @ORM\Entity(repositoryClass="DC\PlatformBundle\Entity\LicencieRepository")
 */
class Licencie
{
    /**
     ...
     * Add codepar
     *
     * @param \DC\PlatformBundle\Entity\Participe $codepar
     * @return Licencie
     */
    public function addCodepar(\DC\PlatformBundle\Entity\Participe $codepar)
    {
     ...
     * @param \DC\PlatformBundle\Entity\Participe $codepar
     */
    public function removeCodepar(\DC\PlatformBundle\Entity\Participe $codepar)
    {

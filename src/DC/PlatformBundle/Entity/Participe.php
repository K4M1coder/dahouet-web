 ...
 * @ORM\Entity(repositoryClass="DC\PlatformBundle\Entity\ParticipeRepository")
 */
class Participe
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="CODEDEC", type="string", length=1, nullable=true, options={"fixed" = true})
     */
    private $codedec;
     ...
     * @var string
     *
     * @ORM\Column(name="NUMPORT", type="string", length=10, nullable=false, options={"fixed" = true})
     */
    private $numport;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="NUMVOIL", referencedColumnName="NUMVOIL", nullable=false)
     * })
     */
    private $numvoil;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="NUMREG", referencedColumnName="NUMREG", nullable=false)
     * })
     */
    private $numreg;
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="NUMLICSKI", referencedColumnName="NUMLIC", nullable=false)
     * })
     */
    private $numlicski;
     ...
     * Set numvoil
     *
     * @param \DC\PlatformBundle\Entity\Voilier $numvoil
     * @return Participe
     */
    public function setNumvoil(\DC\PlatformBundle\Entity\Voilier $numvoil = null)
    {
     ...
     * Get numvoil
     *
     * @return \DC\PlatformBundle\Entity\Voilier 
     */
     ...
     * Set numreg
     *
     * @param \DC\PlatformBundle\Entity\Regate $numreg
     * @return Participe
     */
    public function setNumreg(\DC\PlatformBundle\Entity\Regate $numreg = null)
    {
        $this->numreg = $numreg;
     ...
     * Get numreg
     *
     * @return \DC\PlatformBundle\Entity\Regate 
     */
     ...
     * Set numlicski
     *
     * @param \DC\PlatformBundle\Entity\Licencie $numlicski
     * @return Participe
     */
    public function setNumlicski(\DC\PlatformBundle\Entity\Licencie $numlicski = null)
    {
     ...
     * Get numlicski
     *
     * @return \DC\PlatformBundle\Entity\Licencie 
     */
     ...
     * Add numlic
     *
     * @param \DC\PlatformBundle\Entity\Licencie $numlic
     * @return Participe
     */
    public function addNumlic(\DC\PlatformBundle\Entity\Licencie $numlic)
    {
        $this->numlic[] = $numlic;
     ...
     * @param \DC\PlatformBundle\Entity\Licencie $numlic
     */
    public function removeNumlic(\DC\PlatformBundle\Entity\Licencie $numlic)
    {
